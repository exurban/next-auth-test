const TosPage: React.FC = () => {
  return (
    <div className="px-5 w-5/6 max-w-3xl mx-auto pt-7 pb-10 text-coolGray-800 dark:text-coolGray-50">
      <h1 className="mt-7 mx-auto text-2xl">Gibbs Photography, LLC | Terms of Service</h1>
      <h1 className="mt-6 mb-2 text-xl">OVERVIEW</h1>
      <div className="mb-10">
        <p>
          This website is operated by Gibbs Photography, LLC. Throughout the site, the terms{" "}
          <b>"we"</b>, <b>"us"</b> and <b>"our"</b> refer to Gibbs Photography, LLC. Gibbs
          Photography, LLC offers this website, including all information, tools and services
        ...
        <p className="mt-2">
          ...
          <b>“Service”</b> and agree to be bound by the following terms and conditions (
          <b>“Terms of Service”</b>, <b>“Terms”</b>), including those additional terms and
        ...
        <h1 className="mt-6 mb-2">SECTION 1 - ONLINE STORE TERMS</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 2 - GENERAL CONDITIONS</h1>
        ...
        <h1 className="mt-6 mb-2">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h1>
        ...
        <h1 className="mt-6 mb-2">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 7 - OPTIONAL TOOLS</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 8 - THIRD-PARTY LINKS</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 10 - PERSONAL INFORMATION</h1>
        <p>
          Your submission of personal information through the store is governed by our Privacy
          Policy. To view our Privacy Policy.
        </p>
        <h1 className="mt-6 mb-2">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 12 - PROHIBITED USES</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 14 - INDEMNIFICATION</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 15 - SEVERABILITY</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 16 - TERMINATION</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 17 - ENTIRE AGREEMENT</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 18 - GOVERNING LAW</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 19 - CHANGES TO TERMS OF SERVICE</h1>
        <p>
        ...
        <h1 className="mt-6 mb-2">SECTION 20 - CONTACT INFORMATION</h1>
        <p>
