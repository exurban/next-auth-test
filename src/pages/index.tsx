    ...
    <>
      ...
      <div className="flex flex-col w-11/12 max-w-screen-md mx-auto mt-12 lg:mt-20">
        ...
        <div className="flex flex-col mx-auto  mt-12 lg:mt-20">
          <Link href="/featured">
            <a className="flex flex-col items-center px-4 py-3 max-w-md border border-transparent text-base font-medium rounded-md shadow-sm text-purple-50 bg-indigo-600 shadow-lg hover:bg-purple-600 hover:text-white sm:px-8">
              Enter the Gallery
            </a>
          </Link>
        </div>
