const Footer: React.FC = () => {
  return (
    <>
      <footer className="bg-coolGray-200 dark:bg-coolGray-900 " aria-label="footer">
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center space-x-6">
            <a
              href="#"
              className="text-coolGray-600 hover:text-indigo-600 dark:text-coolGray-500 dark:hover:text-white"
            >
